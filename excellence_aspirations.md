...
This document outlines the quality standards we aspire to uphold across all of Outtalent’s services, products, and interactions. While perfection isn’t the goal, we aim to deliver consistently meaningful, thoughtful, and high-quality experiences that leave a positive and lasting impression.
...
- **Pleasant** - you should want to use the software even if you are depressed and don’t even need it
...
## 🏠 Real-Life Environment and Physical Objects
...
- Ideal
    - Patagonia
- OK (as we are not sure what’s the environmental impact)
    - Nike
    - Lululemon
    - Uniqlo

### 📒 Other Physical Things (e.g. electronics, notebooks, mugs)
